...
import { FaRegCalendar, FaRegClock, FaFileAlt, FaRegCalendarCheck } from "react-icons/fa";
import { FaIdCard, FaExclamationTriangle, FaExclamationCircle, FaTimesCircle, FaUserLock } from "react-icons/fa";
    ...
    return (
        <MainLayout>
            <div className="p-6 bg-gray-100 min-h-screen">
                {/* Header Dropdown */}
                <div className="mb-4">
                    <label className="block text-gray-700 font-semibold mb-1">Type Of Notices</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                        <InfoCard title="Total Notices" count="10" onClick={() => navigate("/notice")}  icon={<FaFileAlt />} />
                        <InfoCard title="Last 15 Days" count="0" icon={<FaRegClock />} />
                        <InfoCard title="Last 24 Hours" count="0" icon={<FaRegClock />} />
                        <InfoCard title="Total Clients" count="3" onClick={() => navigate("/clients")} icon={<FaIdCard />} />
                        <InfoCard title="Open Notices" count="0" icon={<FaExclamationTriangle />} />
                        <InfoCard title="7 Over Due" count="0" icon={<FaExclamationCircle />} />
